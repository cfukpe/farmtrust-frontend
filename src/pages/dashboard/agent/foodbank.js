...
AgentFoodBank.getLayout = function getLayout(page) {
...
export default function AgentFoodBank() {
    const { user } = useAuth();
        ...
        <Page title="Dashboard:">
            <Container maxWidth={themeStretch ? false : 'xl'}>
                ...
                <Grid style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', 'alignItems': 'center' }}>
                    <Typography variant='h1' color='primary'>Under construction</Typography>
                    <Construction style={{ width: '100px' }} />
                </Grid>
