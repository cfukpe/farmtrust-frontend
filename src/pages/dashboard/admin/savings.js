...
export default function UserSavings() {
    ...
    const fetchInitialData = async () => {
        try {
            const res = await SavingService.getAllSaving();
    ...
    const handleApproveSaving = async () => {
        try {
            setLoading(true);
            const res = await SavingService.approveSaving(savingToApprove?.id);
            ...
            return enqueueSnackbar('Saving has been approved', {
                variant: 'success',
                anchorOrigin: {
                    horizontal: 'right',
                    vertical: 'top'
        ...
        <Page title="Dashboard:">
            <Container maxWidth={themeStretch ? false : 'xl'}>
                ...
                <Dialog open={savingToApprove} fullWidth onClose={() => setSavingToApprove(null)}>
                    <SuccessDialogTitle>Approve Saving</SuccessDialogTitle>
                    <Divider />
                    <DialogContent>
                        <Typography variant='body'>Are you sure yo uwant to approve this saving?</Typography>
                    </DialogContent>
                    <DialogActions>
