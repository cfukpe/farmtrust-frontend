...
export default function CategoryProducts() {
    ...
    const filteredProducts = applyFilter(products, sortBy, filters, categoryId);
...
function applyFilter(products, sortBy, filters, categoryId) {
    // SORT BY

    products = products.filter(product => categoryId == product.investment_category_id)
    if (sortBy === 'featured') {
